...
​			发放令牌,有令牌就可以通过,对令牌数量进行控制,类似景区安全带,有安全带就可以玩项目

​	滚动时间窗

​			某段时间内只允许指定数量的数据,超过就限流,缺点存在时间临界点的缺陷	![image-20240421125438546](D:\文件\笔记\img\image-20240421125438546.png)

​	滑动时间窗口

​			解决了滚动时间窗的问题,不断重复时间开始时间
